...
public class PostconditionSuggestionProvider extends AbstractAIESuggestionProvider {
  ...
  public Set<ICompletionProposal> getStartSuggestions() {
    ...
    startSuggestions.add(new AIECompletionProposal(CompletionTokens._postcondition));
    startSuggestions.add(new AIECompletionProposal(CompletionTokens._ensures));
